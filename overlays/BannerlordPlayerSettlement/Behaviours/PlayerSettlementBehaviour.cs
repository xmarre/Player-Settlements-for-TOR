...
namespace BannerlordPlayerSettlement.Behaviours
{
    ...
    public class PlayerSettlementBehaviour : CampaignBehaviorBase
    {
        ...
        const string GhostPortPrefabId = GhostGatePrefabId;
                ...
                (string settlementName) =>
                {
                    ...
                    void Apply(string settlementName, CultureObject culture, string? villageType)
                    {
                        ...
                        void ApplyPlaced(string settlementName, CultureObject culture, string? villageType)
                        {
                            ...
                            overwriteItem.PrefabId = item.PrefabId ?? item.Id;
                ...
                (string settlementName) =>
                {
                    ...
                    void Apply(string settlementName, CultureObject culture, string? villageType)
                    {
                        ...
                        void ApplyPlaced(string settlementName, CultureObject culture, string villageType)
                        {
                            ...
                            target.PrefabId = item.PrefabId ?? item.Id;
                        ...
                        var curModelIdx = availableModels?.FindIndex(a => a.Id == curModelPrefab || (a.PrefabId ?? a.Id) == curModelPrefab) ?? -1;
        ...
        private static void WriteGateDiagnostic(string message)
        {
            try
            {
